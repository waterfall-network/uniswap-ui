...
const WATERFALL_LIST = window?.location?.hostname.includes('testnet')
  ? `https://uniswap.testnet.waterfall.network/testnet-tokens.json`
  : `https://uniswap.waterfall.network/tokens.json`
...
export const DEFAULT_ACTIVE_LIST_URLS: string[] = [WATERFALL_LIST]
